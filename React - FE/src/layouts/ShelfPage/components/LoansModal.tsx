...
export const LoansModal: React.FC<{
    ...
    mobile: boolean, returnBook: any, renewLoan: any
}> = (props) => {
    return (
                            ...
                            <div className="mt-3">
                                ...
                                {props.shelfCurrentLoan.daysLeft > 0 &&
                                    <p className="text-secondary">
                                        Due in {props.shelfCurrentLoan.daysLeft} day.
                                    </p>
                                }
                                {props.shelfCurrentLoan.daysLeft === 0 &&
                                ...
                                {props.shelfCurrentLoan.daysLeft < 0 &&
                                    <p className="text-danger">
                                        Past due by {props.shelfCurrentLoan.daysLeft} day.
                                    </p>
                                }
