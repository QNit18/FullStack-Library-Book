            ...
            <div className="d-none d-lg-block">
                <div className="row g-0 mt-5">
                    ...
                    <div className="col-4 col-md-4 container d-flex 
                        justify-content-center aligin-items-center">
                        <div className="mt-5">
                ...
                <div className="row g-0">
                    <div className="col-4 col-md-4 container d-flex 
                        ...
                        <div className="ml-2">
                            <h1>Our collection is always changings!</h1>
                            <p className="lead">
                                Try to check in daily as our collection is always changing!
                                We work nonstop to provide the most accurate book selection possible
                                for our Anony 18 Read students! We are diligent about our book selection
