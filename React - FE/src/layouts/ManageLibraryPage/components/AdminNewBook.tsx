...
export const AdminNewBook = () => {
    ...
    async function submitNewBook() {
        ...
        if (authState?.isAuthenticated && title !== '' && author !== '' && category !== 'Category'
            ...
            const book: AdminBookRequest = new AdminBookRequest(title, author, description, copies, category);
            ...
            <div className="card">
                ...
                <div className="card-body">
                    <form method="POST">
                        <div className="row">
                            ...
                            <div className="col-md-3 mb-3">
                                ...
                                <ul id="addNewBookId" className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li><a onClick={() => categoryField('DA')} className="dropdown-item">Data</a></li>
                        ...
                        <input type="file" onChange={e => base64ConversionForImage(e)}></input>
                        <div>
